 ...
 */
export { useDBState as useLSState } from './state/localStorage';
 ...
 * @return {[any, function]} - An array containing the current state value and a setter function.
 */
export { useDBState as useSSState } from './state/sessionStorage';
 ...
 * @return {[any, function]} - An array containing the current state value and a setter function.
 */
export { useDBState as useIDbState } from './state/IndexedDB';